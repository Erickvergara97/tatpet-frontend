  ...
  return (
    <div className="text-neutral-700 dark:text-neutral-300">
      <div className="mx-auto text-center md:max-w-xl lg:max-w-3xl">
        <h3 className="mb-6 text-3xl font-bold">Nuestros Servicios</h3>
      ...
      <div className="grid gap-3 text-center md:grid-cols-4">
        <div>
          <div className="block rounded-lg bg-white shadow-lg dark:bg-neutral-700 dark:shadow-black/30">
            ...
            <div className="p-6">
              <h4 className="mb-4 text-2xl font-semibold">Spa</h4>
              <hr />
              <p className="mt-4">
        ...
        <div>
          <div className="block rounded-lg bg-white shadow-lg dark:bg-neutral-700 dark:shadow-black/30">
            ...
            <div className="p-6">
              <h4 className="mb-4 text-2xl font-semibold">Grooming</h4>
              <hr />
              <p className="mt-4">
                <span className="inline-block pe-2 [&>svg]:w-5">
                  <svg
        ...
        <div>
          <div className="block rounded-lg bg-white shadow-lg dark:bg-neutral-700 dark:shadow-black/30">
            ...
            <div className="p-6">
              <h4 className="mb-4 text-2xl font-semibold">Hotel</h4>
              <hr />
              <p className="mt-4">
                <span className="inline-block pe-2 [&>svg]:w-5">
                  <svg
        ...
        <div>
          <div className="block rounded-lg bg-white shadow-lg dark:bg-neutral-700 dark:shadow-black/30">
            ...
            <div className="p-6">
              <h4 className="mb-4 text-2xl font-semibold">Pasadia</h4>
              <hr />
              <p className="mt-4">
                <span className="inline-block pe-2 [&>svg]:w-5">
                  <svg
